...
<body id="body-user-forgot-password">
  ...
  <h2><span><?php _e('Reset', 'stela'); ?></span> <?php _e('password', 'stela'); ?></h2>
  ...
  <div class="user_forms">
      <div class="inner">
        ...
        <fieldset>
          <div>
            <label for="new_email"><?php _e('Parola noua', 'stela') ; ?></label>
            <input type="password" name="new_password" value="" />
          </div>
          <div>
            <label for="new_email"><?php _e('Repeat password', 'stela') ; ?></label>
            <input type="password" name="new_password2" value="" />
          </div>

          <button type="submit" id="blue"><?php _e('Submit', 'stela') ; ?></button>
        </fieldset>
        </form>
      </div>
    </div>
