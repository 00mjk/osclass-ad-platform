<?php 
  ...
  $location = array_filter(array(osc_item_city() <> '' ? osc_item_city() : osc_item_region()));
...
<div class="simple-prod o<?php echo $c; ?><?php if(osc_item_is_premium()) { ?> is-premium<?php } ?><?php if($class <> '') { echo ' ' . $class; } ?> <?php osc_run_hook("highlight_class"); ?>">
  <div class="simple-wrap">
    <div class="item-img-wrap">
     ...
     <a class="img-link no-img" href="<?php echo osc_item_url(); ?>"><img src="<?php echo osc_current_web_theme_url('images/1.png'); ?>" alt="<?php echo osc_esc_html(osc_item_title()); ?>" /></a>
    ...
    <a class="title" href="<?php echo osc_item_url(); ?>"><?php echo osc_highlight(osc_item_title(), 18); ?></a>
    ...
    <div class="description<?php if(osc_item_user_id() > 0) { ?> registered<?php } ?>">
      ...
      <div class="text"><?php echo osc_highlight(strip_tags(osc_item_description()), 27); ?></div>
    </div>
    ...
    <div class="bottom">
      ...
      <?php } ?>
        ...
        <div class="price2">
            ...
            <?php echo stela_smart_date(osc_item_pub_date()); ?>
